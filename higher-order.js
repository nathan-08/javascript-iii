...
let totalPopulation  = populations.reduce( (t, e) => t + e);
...
{"price":48,"tax":0.13}]
//create new arr of price * tax

let ordersTotal = orders.map(  e => e[0] * e[1]);
...
let bobsItems = purchases.filter( e => e['owner'] === 'Bob')
var bobsTotal = 0;
bobsItems.forEach( e => bobsTotal += e['price']);
